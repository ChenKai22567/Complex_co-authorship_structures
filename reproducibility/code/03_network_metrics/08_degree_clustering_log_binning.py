...
# 2. 配置与数据加载
# ==========================================
output_dir = str(_OUTPUT_ROOT / "03_network_metrics" / "degree_clustering_log_binning")

file_path = str(
    _OUTPUT_ROOT
    / "02_network_construction"
    / "coauthorship_network_pipeline"
    / "coauthorship_newman_s2_2006_2025.gexf"
)
