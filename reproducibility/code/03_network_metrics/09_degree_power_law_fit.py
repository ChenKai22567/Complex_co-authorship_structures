...
FILE_PATH = str(_OUTPUT_ROOT / "02_network_construction" / "coauthorship_network_pipeline" / "coauthorship_newman_s2_2006_2025.gexf")

# 图片保存目录
OUTPUT_DIR = str(_OUTPUT_ROOT / "03_network_metrics" / "degree_power_law_fit")
