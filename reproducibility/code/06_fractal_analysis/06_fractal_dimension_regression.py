...
input_dir = str(_OUTPUT_ROOT / "06_fractal_analysis" / "fractal_three_network_comparison")
output_dir = str(_OUTPUT_ROOT / "06_fractal_analysis" / "fractal_dimension_regression")
